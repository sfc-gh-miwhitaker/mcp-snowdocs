...
2. **Run the automated master script (optional but recommended)**
...
4. **Configure your MCP-compatible IDE**
   Update the appropriate configuration file (for example `~/.cursor/mcp.json`) with the MCP URL and programmatic access token returned by the setup scripts. Restart the IDE afterwards.

5. **Review security and documentation**
